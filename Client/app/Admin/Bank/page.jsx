      ...
      <div className="flex items-start gap-3 flex-col md:w-[85%]">
        <div className="flex items-start flex-col md:items-center m-auto md:flex-row justify-between w-full">
          <div className='relative'>
            <span className='text-white uppercase tracking-[5px]'>Bank Challenge</span>
          </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 w-full'>
          {bankData
            ...
            <div key={index} className='flex items-center flex-col gap-3 p-5'>
              ...
              <span className='text-white text-sm text-center w-[80%]'>
                {question.question}
              </span>
              <span className='text-white text-sm'>{question.Answer}</span>
              <button
                onClick={() => deleteItem('bank', question._id)}
